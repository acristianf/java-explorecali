insert into tour_package (code, title)
...
insert into tour_rating (tour_id, customer_id, rating, comment)
values (1, 4, 5, 'I loved it'),
       (2, 100, 5, 'I really thought it could have been better');

-- USER
-- non-encrypted password: letmein
INSERT INTO security_user (username, password, first_name, last_name)
VALUES ('admin', '$2a$12$ZhGS.zcWt1gnZ9xRNp7inOvo5hIT0ngN7N.pN939cShxKvaQYHnnu', 'Administrator', 'Administrator'),
...
INSERT INTO security_role (role_name, description)
VALUES ('ROLE_CSR', 'Customer Service Representative');
